...
| **v0.2.0** | 能力工具链初版 | 🚧 进行中 | 世界观工具链 + 美术参考管线（v0.2.1 ✅ / v0.2.2 ✅ / v0.2.3 ✅ / v0.2.4 ✅ / v0.2.5 待定） |
...
> 🎯 **当前所在**：v0.1.0 ✅ 完成 → v0.2.0 🚧（工具链拆分中，v0.2.1 ✅ · v0.2.2 ✅ · v0.2.3 ✅ · v0.2.4 ✅；v0.2.5 切片装配导出为下一项）→ v0.3.0 → …
...
> ⚠️ 拆分中，逐项讨论定稿（见下方“讨论待办”）。
> 进展：v0.2.1 ✅ 完成 → 0.2.2 → 0.2.3 后统一走演练。
...
- 多切片装配 / 索引导出（消费 skeleton.yaml 的结构化定义）
