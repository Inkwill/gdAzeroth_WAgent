# -*- coding: utf-8 -*-
"""gt_scene_test001 · v4 迭代 · 75° 近俯视 + 末世冷色调压低 + 背景 3D 渲染强化
...
if __name__ == "__main__":
    ...
    # P-01 三张 v2
    print("=== P-01 v4 末世小镇 × 3 ===")
    for i, sd in enumerate([2026097001, 2026097002, 2026097003], 1):
        name = f"wasteland_town_P01_v4_b{i:02d}.png"
        r = submit_wait(wf_p01(sd, f"wasteland_town_P01_v4_b{i:02d}"), f"P01-b{i:02d}", name)
        if r:
            results[name] = r
            write_meta(name,
    ...
    for i, sd in enumerate([2026097004, 2026097005, 2026097006], 1):
        name = f"wasteland_town_P04_v4_b{i:02d}.png"
        r = submit_wait(wf_p04(sd, f"wasteland_town_P04_v4_b{i:02d}"), f"P04-b{i:02d}", name)
        if r:
            results[name] = r
            write_meta(name,
